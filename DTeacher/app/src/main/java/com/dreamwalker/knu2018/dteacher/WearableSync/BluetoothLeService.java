...
//            intent.putExtra(EXTRA_DATA,  stringBuilder.toString() + "\n\n");
        ...
        // TODO: 2018-02-20 TSL2561 값 받는 처리부분
        ...
        else if (characteristic.getUuid().toString().equals(IntentConst.HEXI_HUMIDITY_UUID)){
            ...
            if (tempData != null){
                //amb = String.valueOf(data[0]);
                Log.e(TAG, "broadcastUpdate: HEXI_HUMIDITY_UUID " + data[0] + "," + data[1]);
                intent.putExtra(EXTRA_DATA, tempData);
            }
