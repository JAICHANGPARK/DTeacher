...
public class SignUpActivity1 extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO: 2018-02-13 성별과 나이는 초기 값 주고 시작하도록 한다. 뒤에서 버튼 누를 때 예외처리 하기위함.
...
//                        dialog.show();
                ...
                // TODO: 2018-02-13 Null 값 처리하기
                if (userBirthString == null || userBirthString.equals("")) {
                    userBirthString = "unknown";
                }
                if (userGenderString == null || userGenderString.equals("")){
                    userBirthString = "unknown";
                }

                if (userAgeString.equals("")) {
                    userAgeString = "unknown";
                }
