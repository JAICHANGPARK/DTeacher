...
public abstract class BleRealTimeLibrary extends Activity {
    ...
    private static BluetoothGattCharacteristic mHexiHumidityCharacteristic;
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, final Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                if (mHexiHumidityCharacteristic != null){
                    mConnectionState = connectionStateEnum.isConnected;
                    onConectionStateChange(mConnectionState);
                    mBluetoothLeService.setCharacteristicNotification(mHexiHumidityCharacteristic, true);
                    String tmpString = intent.getStringExtra(BluetoothLeService.EXTRA_DATA);
                    onSerialReceived(tmpString);
                }
...
//			mBluetoothLeService.close();
    ...
    private void getGattServices(List<BluetoothGattService> gattServices) {
        ...
        mHexiHumidityCharacteristic = null;
...
//                    updateConnectionState(R.string.comm_establish);
                ...
                else if (uuid.equals(IntentConst.HEXI_HUMIDITY_UUID)) {
                    mHexiHumidityCharacteristic = gattCharacteristic;
                    System.out.println("HexiStartCharacteristic  " + mHexiHumidityCharacteristic.getUuid().toString());
//                    updateConnectionState(R.string.comm_establish);
                }
...
//                    updateConnectionState(R.string.comm_establish);
        ...
        if (mHexiHumidityCharacteristic != null){
            Log.e(TAG, "getGattServices: mHexiHumidityCharacteristic -  들어왔어요 " );
            mBluetoothLeService.readCharacteristic(mHexiHumidityCharacteristic);
            mBluetoothLeService.setCharacteristicNotification(mHexiHumidityCharacteristic, true);
        }
        ...
        if (mHexiPressureCharacteristic != null){
            ...
            //readCharStart(100, mSCharacteristic);
        }else {
            Toast.makeText(mainContext, "Please select wearable devices", Toast.LENGTH_SHORT).show();
            mConnectionState = connectionStateEnum.isToScan;
            onConectionStateChange(mConnectionState);
