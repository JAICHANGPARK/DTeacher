...
public class AndroidUtils {
    ...
    String getFilePath(@NonNull Context context, @NonNull Uri uri) throws IllegalArgumentException {
        try {
    ...
    String internalGetFilePath(@NonNull Context context, @NonNull Uri uri) throws URISyntaxException {
