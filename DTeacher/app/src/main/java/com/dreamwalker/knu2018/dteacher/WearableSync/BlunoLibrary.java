...
//                }
                ...
                if (mSCharacteristic == mHexiCharacteristic) {
                   ...
                   /* // TODO: 2018-01-24 만약 처음 데이터가 들어왔다면
                    if (tmpStringArray[0].equals("02") && tmpStringArray[1].equals("00") && tmpStringArray[19].equals("03")) {
                        // TODO: 2018-01-24 데이터 저장
                        if (saveFlag == false) {
//                            tmpYear = tmpStringArray[3];
//                            tmpYear += tmpStringArray[4];
//                            year = Integer.parseInt(tmpYear);
//                            System.out.println("year : " + year);
                            //System.out.println("tmpString split" + tmpStringArray[3].getClass().getName());
                            for (int i = 3; i < 19; i++) {
                                realData += tmpStringArray[i];
                                realData += ",";
                                //String realData = String.format("%x",);
                            }
                            onSerialTrans(realData);
                            //ArrayList<String> Test = new ArrayList<>();
                        }
                    }
                    // TODO: 2018-01-24 데이터 저장 종료하기
                    else if (tmpStringArray[0].equals("02") && tmpStringArray[19].equals("03")) {
                        if (tmpStringArray[1] == tmpStringArray[2]) {
                            // TODO: 2018-01-25 한번만 저장하기 위해서
                            //saveFlag = true;

                        }
                        // TODO: 2018-01-24 저장 플래그 업 !  한번만 저장하기 위해
                    }*/


                   /* // TODO: 2018-01-24 만약 처음에 받은 데이터의 첫 바이트가 0x02이면
                    if (tmpStringArray[0].equals("02")){
                        mBluetoothLeService.setCharacteristicNotification(mSCharacteristic, true);
                    }
                    // TODO: 2018-01-24 그 외의 경우에 디스플레이한다.
                    else {
                        onSerialReceived(tmpString);
                    }
                    // TODO: 2018-01-24 setCharacteristicNotification을 False로 하니 다시 받아지지 않음. 
                    if (tmpStringArray[19].equals("03")){
                        // TODO: 2018-01-24 저장을 종료하는 코드를 이쪽에 넣으면 될것이다.
                        //mBluetoothLeService.setCharacteristicNotification(mSCharacteristic, false);
                    }*/
                    //tmpString = tmpString.substring(38,40);
//                    if (tmpString.equals("03")) {
//                        mBluetoothLeService.setCharacteristicNotification(mSCharacteristic, false);
//                    }
