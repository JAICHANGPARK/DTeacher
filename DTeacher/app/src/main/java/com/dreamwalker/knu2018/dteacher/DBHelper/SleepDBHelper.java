...
/**
 * Created by KNU2017 on 2018-05-06.
 */
...
public class SleepDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        sb.append(" CREATE TABLE IF NOT EXISTS SLEEP ( ");
        ...
        sb.append(" SLEEPTIME TEXT, ");
        sb.append(" SATISFACTION TEXT, ");
        sb.append(" DATE TEXT, ");
        sb.append(" TIME TEXT ) ");
        // SQLite Database로 쿼리 실행
        db.execSQL(sb.toString());
        Log.e(TAG, "onCreate: SLEEP DB Table 생성완료");
        Toast.makeText(context, "SLEEP DB Table 생성완료", Toast.LENGTH_SHORT).show();
    }

    @Override
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        String sql = "drop table IF EXISTS SLEEP;"; // 테이블 드랍
        db.execSQL(sql);
        onCreate(db); // 다시 테이블 생성
    }

    public void insertSleepData(String type, String satisfaction, String startDate, String startTime,
                               String endDate, String endTime, String sleepTime,
                               String date, String time) {

        SQLiteDatabase db = getWritableDatabase();
        StringBuffer sb = new StringBuffer();
        sb.append(" INSERT INTO SLEEP ( ");
        sb.append(" TYPE, " +
                "STARTDATE, " +
                "STARTTIME, " +
                "ENDDATE, " +
                ...
                "DATE, TIME ) ");
        sb.append(" VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?) ");
        db.execSQL(sb.toString(), new Object[]{type, startDate, startTime, endDate, endTime, sleepTime, satisfaction, date, time});
